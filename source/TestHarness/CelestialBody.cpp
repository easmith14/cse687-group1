...
void CelestialBody::setsurfaceHeight(double a) {
	surfaceHeight = a;
}
...
TestResponse CelestialBody::Test() {
	...
	result1.Num = 1; // test sequence number
	result1.Name = "test1"; // name of test
	result1.Result = false; // pass fail
	result1.Notes = "placeholder notes1"; // placeholder for test comments
	
	results.push_back(result1);
	// dummy tests function 2
	TestResult result2;

	result1.Num = 2; // test sequence number
	result1.Name = "test2"; // name of test
	result1.Result = true; // pass fail
	result1.Notes = "placeholder notes2"; // placeholder for test comments

	results.push_back(result2);

	TestResponse response(results, true); //function decides whether it was a success as a whole
